...
|	5	|	avarage_tBodyAcc-mean()-Z	|	Avarage Value	of the variable "Mean of the time of body acceleration signals"	in Z-Direction	|
|	6	|	avarage_tBodyAcc-std()-X	|	Avarage Value	of the variable "Standard Deviation of the time of body acceleration signals"	in  X-Direction	|
|	7	|	avarage_tBodyAcc-std()-Y	|	Avarage Value	of the variable "Standard Deviation of the time of body acceleration signals"	in Y-Direction	|
|	8	|	avarage_tBodyAcc-std()-Z	|	Avarage Value	of the variable "Standard Deviation of the time of body acceleration signals"	in Z-Direction	|
|	9	|	avarage_tGravityAcc-mean()-X	|	Avarage Value	of the variable "Mean of the time of gravity acceleration signals"	in  X-Direction	|
|	10	|	avarage_tGravityAcc-mean()-Y	|	Avarage Value	of the variable "Mean of the time of gravity acceleration signals"	in Y-Direction	|
|	11	|	avarage_tGravityAcc-mean()-Z	|	Avarage Value	of the variable "Mean of the time of gravity acceleration signals"	in Z-Direction	|
|	12	|	avarage_tGravityAcc-std()-X	|	Avarage Value	of the variable "Standard Deviation of the time of gravity acceleration signals"	in  X-Direction	|
|	13	|	avarage_tGravityAcc-std()-Y	|	Avarage Value	of the variable "Standard Deviation of the time of gravity acceleration signals"	in Y-Direction	|
|	14	|	avarage_tGravityAcc-std()-Z	|	Avarage Value	of the variable "Standard Deviation of the time of gravity acceleration signals"	in Z-Direction	|
|	15	|	avarage_tBodyAccJerk-mean()-X	|	Avarage Value	of the variable "Mean of the time of body acceleration jerk signals"	in  X-Direction	|
|	16	|	avarage_tBodyAccJerk-mean()-Y	|	Avarage Value	of the variable "Mean of the time of body acceleration jerk signals"	in Y-Direction	|
|	17	|	avarage_tBodyAccJerk-mean()-Z	|	Avarage Value	of the variable "Mean of the time of body acceleration jerk signals"	in Z-Direction	|
|	18	|	avarage_tBodyAccJerk-std()-X	|	Avarage Value	of the variable "Standard Deviation of the time of body acceleration jerk signals"	in  X-Direction	|
|	19	|	avarage_tBodyAccJerk-std()-Y	|	Avarage Value	of the variable "Standard Deviation of the time of body acceleration jerk signals"	in Y-Direction	|
|	20	|	avarage_tBodyAccJerk-std()-Z	|	Avarage Value	of the variable "Standard Deviation of the time of body acceleration jerk signals"	in Z-Direction	|
|	21	|	avarage_tBodyGyro-mean()-X	|	Avarage Value	of the variable "Mean of the time of body  gyro signals"	in  X-Direction	|
|	22	|	avarage_tBodyGyro-mean()-Y	|	Avarage Value	of the variable "Mean of the time of body  gyro signals"	in Y-Direction	|
|	23	|	avarage_tBodyGyro-mean()-Z	|	Avarage Value	of the variable "Mean of the time of body  gyro signals"	in Z-Direction	|
|	24	|	avarage_tBodyGyro-std()-X	|	Avarage Value	of the variable "Standard Deviation of the time of body gyro signals"	in  X-Direction	|
|	25	|	avarage_tBodyGyro-std()-Y	|	Avarage Value	of the variable "Standard Deviation of the time of body gyro signals"	in Y-Direction	|
|	26	|	avarage_tBodyGyro-std()-Z	|	Avarage Value	of the variable "Standard Deviation of the time of body  gyro signals"	in Z-Direction	|
|	27	|	avarage_tBodyGyroJerk-mean()-X	|	Avarage Value	of the variable "Mean of the time of body gyro jerk signals"	in  X-Direction	|
|	28	|	avarage_tBodyGyroJerk-mean()-Y	|	Avarage Value	of the variable "Mean of the time of body gyro jerk signals"	in Y-Direction	|
|	29	|	avarage_tBodyGyroJerk-mean()-Z	|	Avarage Value	of the variable "Mean of the time of body gyro jerk signals"	in Z-Direction	|
|	30	|	avarage_tBodyGyroJerk-std()-X	|	Avarage Value	of the variable "Standard Deviation of the time of body gyro jerk signals"	in  X-Direction	|
|	31	|	avarage_tBodyGyroJerk-std()-Y	|	Avarage Value	of the variable "Standard Deviation of the time of body gyro jerk signals"	in Y-Direction	|
|	32	|	avarage_tBodyGyroJerk-std()-Z	|	Avarage Value	of the variable "Standard Deviation of the time of body gyro jerk signals"	in Z-Direction	|
|	33	|	avarage_tBodyAccMag-mean()	|	Avarage Value	of the variable "Mean of the time of body acceleration mag signals"		|
|	34	|	avarage_tBodyAccMag-std()	|	Avarage Value	of the variable "Standard Deviation of the time of body acceleration mag signals"		|
